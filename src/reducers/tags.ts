import {
  ...
  RemoveTagAction,
  SetTagsAction, TagsActionsTypes, TagsStoreState,
  UpdateTagAction
...
type TagsAction = SetTagsAction | AddTagAction | RemoveTagAction | UpdateTagAction | DisplayTagsModalAction;

export default (state: TagsStoreState = tagsReducerDefaultState, action: TagsAction) => {
  switch (action.type) {
